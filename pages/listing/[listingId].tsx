      ...
      <main className="max-w-6xl mx-auto p-2 flex flex-col lg:flex-row space-y-10 space-x-5 pr-10">
        ...
        <section className="flex-1 space-y-5 pb-20 lg:pb-0">
          <div>
            ...
            <p className="flex items-center text-xs sm:text-base py-2 mt-2">
                  ...
                  <div>
                    ...
                    {listing.sellerAddress === address && (
                      <button
                        ...
                        className="p-2 w-32 bg-cyan-400 rounded-lg font-bold text-xs cursor-pointer"
                      >
                        Accept Offer
                      </button>
                    )}
          ...
          <div className="grid grid-cols-2 space-y-2 items-center justify-end">
            ...
            <button
              ...
              className="bg-cyan-400 font-bold text-white rounded-full w-44 py-4 px-10"
            >
